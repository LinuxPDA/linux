...
#define COLLIE_LOCOMO_GPIO_LCD_VSHA_ON	LOCOMO_GPIO(4)
#define COLLIE_LOCOMO_GPIO_LCD_VSHD_ON	LOCOMO_GPIO(5)
#define COLLIE_LOCOMO_GPIO_LCD_VEE_ON	LOCOMO_GPIO(6)
#define COLLIE_LOCOMO_GPIO_LCD_MOD	LOCOMO_GPIO(7)
#define COLLIE_LOCOMO_GPIO_DAC_ON	LOCOMO_GPIO(8)
#define COLLIE_LOCOMO_GPIO_FL_VR	LOCOMO_GPIO(9)
